...
from legacy_core.planner import AgenticPlanner
from legacy_core.tools import ToolRegistry
from legacy_core.tools_enhanced import (
    create_advanced_search_tool,
    create_multi_stage_filter,
    create_ml_ranking_tool,
    create_analytics_tool
)
from legacy_core.evaluation_suite import ComprehensiveEvaluationSuite
...
def run_ablation_study(orchestrator, test_profiles: List[UserProfile]):
    ...
    for i, profile in enumerate(test_profiles, 1):
        ...
        # 평가
        from legacy_core.evaluation_suite import RecommendationEvaluator
