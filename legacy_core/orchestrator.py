...
from legacy_core.llm_client import LLMClient
from legacy_core.rag_system import RAGSystem
from legacy_core.tools import (
    ToolRegistry,
    create_search_tool,
    create_filter_tool,
...
from legacy_core.evaluator import MatchingEvaluator
from legacy_core.ground_truth import build_rule_based_ground_truth
from legacy_core.experiment_logger import ExperimentLogger  # 선택 사용

from legacy_agents.data_collector import DataCollectionAgent
from legacy_agents.rag_builder import RAGBuilderAgent
from legacy_agents.semantic_matcher import SemanticMatchingAgent
from legacy_agents.llm_reasoner import LLMReasoningAgent
from legacy_agents.recommender import RecommendationAgent
from legacy_agents.agentic_base import ChatbotAgenticAgent, RecommendationAgenticAgent
        ...
        try:
            ...
            if use_cache and self.raw_cache_path.exists():
                ...
                raw_data = self.data_agent.collect_all(
                    ...
                    days_range=Config.DATA_DAYS_RANGE,
                )
        ...
        **kwargs,
        ...
        try:
            ...
            if not self.chatbot_agent:
                from legacy_agents.chatbot import ChatbotAgent
